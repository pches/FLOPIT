...
flood_rasters <- c('Input_data/Muncy_data/depth_10pct_projected_clipped.tif', 
                   'Input_data/Muncy_data/depth_02pct_projected_clipped.tif',
                   'Input_data/Muncy_data/depth_01pct_projected_clipped.tif', 
                   'Input_data/Muncy_data/depth_0_2pct_projected_clipped.tif')
# file location of the elevation map for Muncy, PA, preprocessed to the same coordinate system and spatial extent
elevation_raster <- c('Input_data/Muncy_data/Muncy_dem_resampled.tif')
...
flopit_Muncy_spline <- FLOPIT(flood_rasters, 
                              flood_probabilities, 
                              elevation_raster, 
                              depth = TRUE, 
                              aggregation_value = 4, 
                              method = 'spline', 
                              save_outputs = TRUE, 
                              save_path_map = 'Output/Muncy/Data/saved_map_spline',
                              save_path_data = 'Output/Muncy/Data/saved_data_spline', 
                              save_path_zones = 'Output/Muncy/Data/saved_zones_spline',
                              map_type = 'return period')

######################### FLOPIT analysis: FEMA log-linear interpolation scheme
flopit_Muncy_loglinear <- FLOPIT(flood_rasters, 
                                 flood_probabilities, 
                                 elevation_raster, 
                                 depth = TRUE, 
                                 aggregation_value = 4, 
                                 method = 'log-linear', 
                                 save_outputs = TRUE, 
                                 save_path_map = 'Output/Muncy/Data/saved_map_logLin',
                                 save_path_data = 'Output/Muncy/Data/saved_data_logLin', 
                                 save_path_zones = 'Output/Muncy/Data/saved_zones_logLin',
                                 map_type = 'return period')
...
pdf("Output/Muncy/Figures/FLOPIT_Muncy_rtmap.pdf",width = 187*0.0393701, height = 187*(100/141)*0.0393701)
...
pdf("Output/Muncy/Figures/FLOPIT_Muncy_zones.pdf",width = 187*0.0393701, height = 187*(100/141)*0.0393701)
...
pdf("Output/Muncy/Figures/FLOPIT_prob_zone_difference.pdf",width = 187*0.0393701, height = 187*(100/141)*0.0393701)
...
pdf("Output/Muncy/Figures/zone_vs_probabilities_boxplot.pdf",width = 187*0.0393701, height = 187*(100/141)*0.0393701)
