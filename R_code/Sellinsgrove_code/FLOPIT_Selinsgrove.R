...
flopit_Selinsgrove_spline <- FLOPIT(flood_rasters, flood_probabilities, elevation_raster, depth = TRUE, aggregation_value = 10, 
                              method = 'spline', save = FALSE, map_type = 'return period')

######################### FLOPIT analysis: FEMA log-linear interpolation scheme
flopit_Selinsgrove_loglinear <- FLOPIT(flood_rasters, flood_probabilities, elevation_raster, depth = TRUE, aggregation_value = 10, 
